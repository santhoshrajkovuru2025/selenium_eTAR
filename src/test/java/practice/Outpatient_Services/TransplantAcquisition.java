...
public class TransplantAcquisition {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Transplant Acquisition']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("33999");
	driver.findElement(By.xpath("//input[@name='TotUnitsReq']")).sendKeys("12");
	driver.findElement(By.xpath("//input[@name='FromDate']")).clear();
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09302024");
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09302024");
	driver.findElement(By.xpath("//input[@name='Submit']")).click();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TransplantAcquisition TAR = new TransplantAcquisition();
		TAR.logintoeTAR();
