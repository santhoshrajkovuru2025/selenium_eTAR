...
public class HyperbaricOxygen {
	...
	Thread.sleep(500);
	driver.findElement(By.cssSelector("body > div:nth-child(5) > div:nth-child(2) > div:nth-child(3) > center:nth-child(4) > center:nth-child(6) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(4) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(7) > td:nth-child(2) > a:nth-child(1)")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("C1300");
	...
	Select freqind = new Select(FreqInd);
	freqind.selectByIndex(6);
	WebElement POS = driver.findElement(By.xpath("//select[@name='POS']"));
	Select place = new Select(POS);
	place.selectByIndex(13);
	driver.findElement(By.xpath("//input[@name='FromDate']")).clear();
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09262024");
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09262024");	
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).clear();
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).sendKeys("09262024");
	...
	driver.findElement(By.xpath("//input[@name='Serv_DateOnset_1']")).sendKeys("09262024");
	driver.findElement(By.xpath("//textarea[@name='TreatSummary']")).sendKeys("No Treatment taken Till Date");
	driver.findElement(By.xpath("//textarea[@name='SimilarServ']")).sendKeys("No Similar Service Found");
	driver.findElement(By.xpath("//textarea[@name='PhysPresc']")).sendKeys("No Prescription Needed");
	driver.findElement(By.xpath("//input[@name='PhysLicNum']")).sendKeys("1548201965");
	driver.findElement(By.xpath("//input[@name='PhysName']")).sendKeys("Hellen");
	driver.findElement(By.xpath("//input[@name='PhysPhne1']")).sendKeys("454");
	driver.findElement(By.xpath("//input[@name='PhysPhne2']")).sendKeys("454");
	driver.findElement(By.xpath("//input[@name='PhysPhne3']")).sendKeys("4545");
	driver.findElement(By.xpath("//input[@name='PrescriptDte']")).sendKeys("09262024");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		HyperbaricOxygen TAR = new HyperbaricOxygen();
		TAR.logintoeTAR();
