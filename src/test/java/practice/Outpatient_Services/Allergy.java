...
public class Allergy {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Allergy']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("C9351");
	...
	Select freqInd = new Select(FrequencyInd);
	freqInd.selectByValue("W");
	driver.findElement(By.xpath("//input[@name='AntLength']")).sendKeys("11");
	WebElement AntLenInd = driver.findElement(By.xpath("//select[@name='AntLengthInd']"));
	Select antlenind = new Select(AntLenInd);
	antlenind.selectByValue("W");
