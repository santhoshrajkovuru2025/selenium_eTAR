package practice.Outpatient_Services;
...
public class OfficeVisits_RestrictedProvider {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Office Visits - Restricted Provider']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("90657");
	driver.findElement(By.xpath("//input[@name='TotUnitsReq']")).sendKeys("12");
	driver.findElement(By.xpath("//input[@name='FromDate']")).clear();
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09272024");
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09272024");
	WebElement Side = driver.findElement(By.xpath("//select[@name='side']"));
	Select side = new Select(Side);
	side.selectByValue("L");
	driver.findElement(By.xpath("//input[@name='AntLength']")).sendKeys("11");
	WebElement AntInd = driver.findElement(By.xpath("//select[@name='AntLengthInd']"));
	Select AntLen = new Select(AntInd);
	AntLen.selectByValue("W");
	...
	driver.findElement(By.xpath("//input[@name='Serv_DateOnset_1']")).sendKeys("09272024");
	WebElement PlaceofTreatment = driver.findElement(By.xpath("//select[@name='POT']"));
	Select place = new Select(PlaceofTreatment);
	place.selectByIndex(2);
	driver.findElement(By.xpath("//input[@name='Feet']")).sendKeys("5");
	driver.findElement(By.xpath("//input[@name='Inches']")).sendKeys("11");
	driver.findElement(By.xpath("//input[@name='Pounds']")).sendKeys("120");
	...
	driver.findElement(By.xpath("//textarea[@name='TreatSummary']")).sendKeys("No Treatment Summary found");
	driver.findElement(By.xpath("//textarea[@name='SimilarServ']")).sendKeys("No Similar Service Found");
	driver.findElement(By.xpath("//textarea[@name='GoalSummary']")).sendKeys("No Theraupetic Goal");
	driver.findElement(By.xpath("//textarea[@name='ExplCost']")).sendKeys("costly method of treatment");
	driver.findElement(By.xpath("//textarea[@name='PhysPresc']")).sendKeys("No Prescription Found");
	driver.findElement(By.xpath("//input[@name='PhysLicNum']")).sendKeys("00A088470");
	driver.findElement(By.xpath("//input[@name='PhysName']")).sendKeys("Prescribing provider 1");
	...
	driver.findElement(By.xpath("//input[@name='PrescriptDte']")).sendKeys("09272024");
	driver.findElement(By.xpath("//input[@name='Submit3']")).click();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		OfficeVisits_RestrictedProvider TAR = new OfficeVisits_RestrictedProvider();
		TAR.logintoeTAR();
