...
public class FPACT {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='FPACT']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("58562");
	...
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09252024");
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).clear();
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).sendKeys("09252024");
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09252024");	
	driver.findElement(By.xpath("//input[@name='DischDate']")).clear();
	driver.findElement(By.xpath("//input[@name='DischDate']")).sendKeys("09252024");
	WebElement  Discharge = driver.findElement(By.xpath("//select[@name='Discharge']"));
	Select discharge = new Select(Discharge);
	discharge.selectByIndex(2);
