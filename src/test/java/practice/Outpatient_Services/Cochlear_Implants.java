...
public class Cochlear_Implants {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Cochlear Implants']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("L8691");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Cochlear_Implants TAR = new Cochlear_Implants();
		TAR.logintoeTAR();
