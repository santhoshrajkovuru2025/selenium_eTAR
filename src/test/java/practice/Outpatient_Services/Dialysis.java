...
public class Dialysis {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Dialysis']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("Z6000");
	...
	Select schedule = new Select(Schedule);
	schedule.selectByIndex(2);
	...
	driver.findElement(By.xpath("//input[@name='PrescriptDte']")).sendKeys("09242024");
