...
public class ADHC {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='ADHC']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("Z8500");
	...
	Select Admit = new Select(AdmitFrom);
