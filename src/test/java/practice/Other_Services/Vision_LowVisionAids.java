...
public class Vision_LowVisionAids {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Vision - Low Vision Aids']")).click();
	...
	driver.findElement(By.xpath("//input[@name='Serv_DateOnset_1']")).sendKeys("10022024");
	...
	WebElement Replacement = driver.findElement(By.xpath("//select[@name='VisReplaceRsn_1']"));
	Select Reason = new Select(Replacement);
	...
	WebElement VisualFeildDefects_RE = driver.findElement(By.xpath("//select[@name='VisDefectTypeRE']"));
	Select visual_RE= new Select(VisualFeildDefects_RE);
	visual_RE.selectByIndex(3);
	WebElement VisualFeildDefects_LE = driver.findElement(By.xpath("//select[@name='VisDefectTypeLE']"));
	Select visual_LE= new Select(VisualFeildDefects_LE);
	...
	WebElement SensitivityToGlare = driver.findElement(By.xpath("//select[@name='GlareSensitivity']"));
	Select sensitivity = new Select(SensitivityToGlare);
	sensitivity.selectByIndex(3);
	driver.findElement(By.xpath("//input[@name='ManufacturerRE']")).sendKeys("Lenskart");
	driver.findElement(By.xpath("//input[@name='ModelRE']")).sendKeys("M001");
	driver.findElement(By.xpath("//input[@name='ModelDesc']")).sendKeys("Avaitors");
	driver.findElement(By.xpath("//textarea[@name='PurposeLowVisionAid']")).sendKeys("Neural Constricted Vision");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Vision_LowVisionAids TAR = new Vision_LowVisionAids();
		TAR.logintoeTAR();
