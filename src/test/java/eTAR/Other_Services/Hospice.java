...
public class Hospice {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Hospice']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("Q5010");
	...
	driver.findElement(By.xpath("//input[@name='DateOnset_1']")).clear();
	driver.findElement(By.xpath("//input[@name='DateOnset_1']")).sendKeys("10012024");
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("500");
	driver.findElement(By.xpath("//textarea[@name='TreatSummary']")).sendKeys("No Summary for the Treatment");
	driver.findElement(By.xpath("//input[@name='Submit']")).click();
