...
public class HomeHealth {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Home Health']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("G0365");
