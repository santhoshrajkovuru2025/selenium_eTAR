...
public class TransplantProcedure_Other {
	...
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("44135");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TransplantProcedure_Other TAR = new TransplantProcedure_Other();
		TAR.logintoeTAR();
