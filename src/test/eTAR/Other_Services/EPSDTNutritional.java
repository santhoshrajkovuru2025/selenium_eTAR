...
public class EPSDTNutritional {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='EPSDT Nutritional']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("Z5800");
	...
	WebElement QuantityInd = driver.findElement(By.xpath("//select[@name='QuantityInd']"));
	Select QuanInd = new Select(QuantityInd);
	QuanInd.selectByIndex(6);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		EPSDTNutritional TAR = new EPSDTNutritional();
		TAR.logintoeTAR();
