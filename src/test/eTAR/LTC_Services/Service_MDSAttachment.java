...
public class Service_MDSAttachment {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='NFA/NFB Non-Electronic MDS']")).click();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Service_MDSAttachment TAR = new Service_MDSAttachment();
		TAR.logintoeTAR();
