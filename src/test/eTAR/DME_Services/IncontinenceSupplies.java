...
public class IncontinenceSupplies {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[contains(text(),'Incontinence')]")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("A5123");
	driver.findElement(By.xpath("//input[@name='Quantity']")).sendKeys("12");
	WebElement Quantity = driver.findElement(By.xpath("//select[@name='QuantityInd']"));
	...
	driver.findElement(By.xpath("//input[@alt='Yes TAR Required 1']")).click();
	driver.findElement(By.xpath("//input[@name='ServCodeD_1']")).sendKeys("A5123");
	driver.findElement(By.xpath("//input[@name='DayUseD_1']")).sendKeys("1");
	driver.findElement(By.xpath("//input[@name='UnitCostD_1']")).sendKeys("1");
	driver.findElement(By.xpath("//input[@name='MonUseD_1']")).sendKeys("1");
	driver.findElement(By.xpath("//input[@name='MonCostD_1']")).sendKeys("1");
	driver.findElement(By.xpath("//input[@name='TotUnitsD_1']")).sendKeys("1");
	driver.findElement(By.xpath("//input[@name='TotCostD_1']")).sendKeys("10"); 
	WebElement Prescription = driver.findElement(By.xpath("//select[@name='Prescript_D']"));
	Select P = new Select(Prescription);
	P.selectByValue("09");
	driver.findElement(By.xpath("//input[@alt='Yes Generic']")).click();
	driver.findElement(By.xpath("//input[@name='PhysLicNumD']")).sendKeys("1548201965");
	driver.findElement(By.xpath("//input[@name='PhysNameD']")).sendKeys("Prescribing provider1");
	driver.findElement(By.xpath("//input[@name='PhysPhne1D']")).sendKeys("252");
	driver.findElement(By.xpath("//input[@name='PhysPhne2D']")).sendKeys("252");
	driver.findElement(By.xpath("//input[@name='PhysPhne3D']")).sendKeys("2525");
	driver.findElement(By.xpath("//input[@name='PrescriptDteD']")).sendKeys("09242024");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		IncontinenceSupplies TAR = new IncontinenceSupplies();
		TAR.logintoeTAR();
