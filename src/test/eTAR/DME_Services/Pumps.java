...
public class Pumps {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Pumps (non-IV)']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("K0538");
	...
	driver.findElement(By.xpath("//input[@alt='Rreplace Yes']")).click();
