...
public class ApneaMonitor {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Apnea Monitor']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("K0739");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ApneaMonitor TAR = new ApneaMonitor();
		TAR.logintoeTAR();
