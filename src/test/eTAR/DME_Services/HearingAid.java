...
public class HearingAid {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Hearing Aid']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("V5011");
	...
	driver.findElement(By.xpath("//textarea[@name='SimilarServ']")).sendKeys("No Service Received");
	...
	driver.findElement(By.xpath("//input[@name='ExamProv']")).sendKeys("1548201965");
	driver.findElement(By.xpath("//input[@name='ExamDte']")).sendKeys("09242024");
	WebElement ExamLOC = driver.findElement(By.xpath("//select[@name='ExamLoc']"));
	Select exam = new Select(ExamLOC);
	exam.selectByVisibleText("Home");
	
	WebElement Earfitted = driver.findElement(By.xpath("//select[@name='EarFit']"));
	Select Ear = new Select(Earfitted);
	Ear.selectByValue("5");
