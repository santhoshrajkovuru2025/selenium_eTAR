...
public class HospitalDays {
    ...
    public void addServiceInformation() throws InterruptedException {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("10012025");
            driver.findElement(By.xpath("//input[@name='AdmitDate']")).clear();
            driver.findElement(By.xpath("//input[@name='AdmitDate']")).sendKeys("10012025");
            driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
            driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("10012025");
            driver.findElement(By.xpath("//input[@name='DischDate']")).clear();
            driver.findElement(By.xpath("//input[@name='DischDate']")).sendKeys("10012025");
