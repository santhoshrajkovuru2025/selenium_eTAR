...
public class Service_ICF_DD {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='ICF-DD']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("31");
	...
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("845");
	...
	WebElement MedFreq = driver.findElement(By.xpath("//select[@name='MedFreq_1']"));
	Select medfreq = new Select(MedFreq);
	medfreq.selectByValue("PC");
	WebElement Route = driver.findElement(By.xpath("//select[@name='MedRte_1']"));
	Select route = new Select(Route);
	route.selectByValue("PO");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Service_ICF_DD TAR = new Service_ICF_DD();
		TAR.logintoeTAR();
