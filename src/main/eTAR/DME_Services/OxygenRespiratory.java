...
public class OxygenRespiratory {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Ox/Respiratory']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("94400");
	...
	driver.findElement(By.xpath("//input[@alt='Ryeplace Yes']")).click();
	...
	driver.findElement(By.xpath("//span[@class='content']//input[2]")).click();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		OxygenRespiratory TAR = new OxygenRespiratory();
		TAR.logintoeTAR();
