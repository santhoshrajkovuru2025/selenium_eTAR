...
public class OrthoticsProsthetics {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[contains(text(),'Orthotics')]")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("S0395");
	...
	pot.selectByValue("4");
	driver.findElement(By.xpath("//input[@name='PhysLimit_1']")).sendKeys("956");
	driver.findElement(By.xpath("//input[@name='PrevPhysLimit_1']")).sendKeys("745");
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("965");
	driver.findElement(By.xpath("//textarea[@name='SimilarServ']")).sendKeys("No Service Taken");
	
	driver.findElement(By.xpath("//textarea[@name='PhysPresc']")).sendKeys("No Prescription Required");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		OrthoticsProsthetics TAR = new OrthoticsProsthetics();
		TAR.logintoeTAR();
