...
public class DME_BEDS {
	...
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("X2996");
	Thread.sleep(500);
	driver.findElement(By.xpath("//input[@name ='ModifierCode1']")).sendKeys("HE");
	driver.findElement(By.xpath("//input[@name ='TotUnitsReq']")).sendKeys("11");
	driver.findElement(By.xpath("//input[@name='FromDate']")).clear();
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09142024");
	Thread.sleep(500);
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09142024");
	Thread.sleep(1000);
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).clear();
	driver.findElement(By.xpath("//input[@name='AdmitDate']")).sendKeys("09142024");
	...
	driver.findElement(By.xpath("//input[@name='PrescriptDte']")).sendKeys("09122024");
	driver.findElement(By.xpath("//input[@name='TurningSchedule']")).sendKeys("1");
	WebElement UTS = driver.findElement(By.xpath("//select[@name='UTS_1']"));
	Select uts = new Select(UTS);
	uts.selectByVisibleText("Prone");

	WebElement UTSRsn = driver.findElement(By.xpath("//select[@name='UTSRsn_1']"));
	Select rsn = new Select(UTSRsn);
	rsn.selectByVisibleText("Bed Not Supportive");
	
	Thread.sleep(500);
	driver.findElement(By.xpath("//input[@name='LabDate']")).clear();
	driver.findElement(By.xpath("//input[@name='LabDate']")).sendKeys("09122024");
