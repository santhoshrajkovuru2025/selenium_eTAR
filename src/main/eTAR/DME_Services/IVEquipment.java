...
public class IVEquipment {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='IV Equipment']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("96523");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		IVEquipment TAR = new IVEquipment();
		TAR.logintoeTAR();
