...
public class DMEOthers {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Other']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("E8000");
	driver.findElement(By.xpath("//input[@name='ModifierCode1']")).sendKeys("NU");
	driver.findElement(By.xpath("//input[@name='AntLength']")).sendKeys("1");
	...
	driver.findElement(By.xpath("//input[@name='PhysLimit_1']")).sendKeys("585");
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("859");
	...
	driver.findElement(By.xpath("//input[@alt='Yes Home Accessible']")).click();
	driver.findElement(By.xpath("//input[@alt='Yes Safe Operation']")).click();
	driver.findElement(By.xpath("//input[@alt='Yes Independent Operation']")).click();
