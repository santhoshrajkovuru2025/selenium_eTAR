...
public class TeleMed {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='TeleMed']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("Q3014");
	...
	WebElement ICD_CODE1 = driver.findElement(By.xpath("//select[@name='Serv_ICDCodeType_1']"));
	Select icd1 = new Select(ICD_CODE1);
	icd1.selectByIndex(1);
	driver.findElement(By.xpath("//input[@name='ICD9_1']")).sendKeys("A92.5");
