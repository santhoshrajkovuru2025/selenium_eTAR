...
public class HopTel {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='HopTel']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("S9994");
	...
	WebElement  AdmitFrom = driver.findElement(By.xpath("//select[@name='AdmFrm']"));
	Select Admitfrom = new Select(AdmitFrom);
	Admitfrom.selectByIndex(2);
