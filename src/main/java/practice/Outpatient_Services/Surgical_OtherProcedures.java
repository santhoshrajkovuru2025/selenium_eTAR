...
public class Surgical_OtherProcedures {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Portable X-ray']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("R0070");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Surgical_OtherProcedures TAR = new Surgical_OtherProcedures();
		TAR.logintoeTAR();
