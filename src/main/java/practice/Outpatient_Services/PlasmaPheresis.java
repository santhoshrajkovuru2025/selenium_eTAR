...
public class PlasmaPheresis {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Plasma Pheresis']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("S2120");
	driver.findElement(By.xpath("//input[@name='TotUnitsReq']")).sendKeys("12");
	driver.findElement(By.xpath("//input[@name='FromDate']")).clear();
	driver.findElement(By.xpath("//input[@name='FromDate']")).sendKeys("09012024");
	driver.findElement(By.xpath("//input[@name='ThruDate']")).clear();
	driver.findElement(By.xpath("//input[@name='ThruDate']")).sendKeys("09012024");
	...
	driver.findElement(By.xpath("//input[@name='Serv_DateOnset_1']")).sendKeys("09012024");
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("500");
	...
	driver.findElement(By.xpath("//input[@name='AltServCode_1']")).sendKeys("A52.9");
	driver.findElement(By.xpath("//input[@name='AlternateDesc_1']")).sendKeys("Test Description");
    WebElement AltReason =	driver.findElement(By.xpath("//select[@name='AltReason_1']"));
	Select reason = new Select(AltReason);
	...
	driver.findElement(By.xpath("//input[@name='PrescriptDte']")).sendKeys("09012024");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		PlasmaPheresis TAR = new PlasmaPheresis();
		TAR.logintoeTAR();
