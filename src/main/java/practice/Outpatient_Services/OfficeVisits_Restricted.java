...
public class OfficeVisits_Restricted {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='Office Visits - Restricted']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("92230");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		OfficeVisits_Restricted TAR = new OfficeVisits_Restricted();
		TAR.logintoeTAR();
