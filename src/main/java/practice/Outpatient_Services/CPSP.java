...
public class CPSP {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[normalize-space()='CPSP']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("S9452");
	...
	driver.findElement(By.xpath("//input[@name='MedStat_1']")).sendKeys("585");
