...
public class Speech_Occupational {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[contains(text(),'Speech')]")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("92559");
	...
	driver.findElement(By.xpath("//input[@name='HrsDay']")).sendKeys("5");
	driver.findElement(By.xpath("//input[@name='DaysWk']")).sendKeys("2");
	...
	driver.findElement(By.xpath("//textarea[@name='TreatSummary']")).sendKeys("No Treatment Summary");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Speech_Occupational TAR = new Speech_Occupational();
		TAR.logintoeTAR();
