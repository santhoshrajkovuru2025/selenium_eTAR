...
public class SurgicalOtherProcedures {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[text()=' Surgical/Other Procedures']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("83632");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		SurgicalOtherProcedures TAR = new SurgicalOtherProcedures();
		TAR.logintoeTAR();
