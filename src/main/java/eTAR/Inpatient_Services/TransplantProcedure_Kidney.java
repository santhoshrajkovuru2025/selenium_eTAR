...
public class TransplantProcedure_Kidney {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[text()=' Transplant ']")).click();
	driver.findElement(By.xpath("//input[@name='ServiceCode']")).sendKeys("50300");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TransplantProcedure_Kidney TAR = new TransplantProcedure_Kidney();
		TAR.logintoeTAR();
