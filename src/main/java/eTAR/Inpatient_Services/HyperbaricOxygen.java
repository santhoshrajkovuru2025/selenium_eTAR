package eTAR.Inpatient_Services;
...
public class HyperbaricOxygen {
	...
	Thread.sleep(500);
	driver.findElement(By.xpath("//a[text()=' Hyperbaric Oxygen']")).click();
	...
	driver.findElement(By.xpath("//input[@name='Frequency']")).sendKeys("12");
	WebElement FrequencyInd = driver.findElement(By.xpath("//select[@name='FrequencyInd']"));
	Select Freq = new Select(FrequencyInd);
	Freq.selectByIndex(6);
	WebElement POS = driver.findElement(By.xpath("//select[@name='POS']"));
	Select pos = new Select(POS);
	pos.selectByIndex(13);
	...
	driver.findElement(By.xpath("//input[@name='Serv_DateOnset_1']")).sendKeys("09242024");
	driver.findElement(By.xpath("//textarea[@name='TreatSummary']")).sendKeys("Summary");
